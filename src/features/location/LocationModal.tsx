        ...
        <div className="location-modal-intro grid border-b border-stone-100 p-6">
          <div>
            ...
            <p className="location-modal-description mt-3 max-w-3xl text-base leading-relaxed text-stone-600">
              Procesadora De Alimentos Cale, S.A. De C.V. abre sus puertas bajo coordinacion previa.
              Contactanos para preparar tu visita.
            </p>
          </div>
        </div>
          ...
          <div className="overflow-hidden rounded-lg p-4">
            <div className="overflow-hidden rounded-lg border border-stone-200">
              <iframe
                ...
                title="Mapa de ubicacion de Dulces Jovy"
      ...
      <aside className="location-modal-aside grid gap-4">
        <div className="rounded-lg border border-stone-200 bg-white p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-stone-500">Datos de ubicacion</p>
          ...
          <div className="mt-4 flex gap-3 rounded-lg border border-stone-200 bg-stone-50 p-4">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-stone-700">Direccion</p>
        ...
        <div className="rounded-lg border border-stone-200 bg-white p-6">
          <p className="text-xs font-semibold uppercase tracking-wider text-stone-500">Proximo paso</p>
