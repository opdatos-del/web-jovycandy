...
export const Certifications: React.FC = () => {
  return (
    <section className="relative z-20 flex w-full items-center justify-center overflow-hidden bg-[linear-gradient(180deg,#e83e8c_0%,#dc3545_100%)] px-6 pb-24 pt-12 md:px-12 md:pb-32 md:pt-16 lg:px-24">
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        >
          <h2 className="text-white/70 text-xs uppercase tracking-[0.5em] mb-6 font-mono">
