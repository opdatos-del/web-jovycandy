...
export const UpcomingEventsIntroCard = () => (
  <ScrollReveal
    className="h-[72vh] w-[min(74vw,23rem)] shrink-0 md:h-[76vh] md:w-[min(40vw,24rem)] lg:w-[min(25vw,23rem)]"
    delay={0.05}
    distance={34}
  >
    <article className="flex h-full flex-col justify-between rounded-[2.4rem] border border-[#f0d9d0] bg-white/92 p-6 shadow-[0_28px_90px_rgba(227,145,112,0.15)] md:p-8">
