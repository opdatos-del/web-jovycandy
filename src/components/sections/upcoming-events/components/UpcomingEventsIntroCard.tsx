  ...
  >
    <article className="flex h-full flex-col justify-between rounded-[2rem] border border-[#f0d9d0] bg-white/92 p-5 shadow-[0_28px_90px_rgba(227,145,112,0.15)] sm:p-6 lg:rounded-[2.4rem] lg:p-8">
      <div className="space-y-5">
        <span className="inline-flex rounded-full border border-[#f6cab7] bg-white/80 px-4 py-2 text-[10px] font-semibold uppercase tracking-[0.22em] text-[#d27055] sm:tracking-[0.35em]">
          Proximos eventos
        </span>

        <div>
          <p className="text-xs uppercase tracking-[0.28em] text-stone-400 sm:tracking-[0.45em]">Agenda visual</p>
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <p className="text-[11px] uppercase tracking-[0.22em] text-stone-500 sm:tracking-[0.35em]">Sigue bajando</p>
        </div>
