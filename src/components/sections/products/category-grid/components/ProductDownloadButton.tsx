...
export const ProductDownloadButton = ({ accentColor, className = '' }: ProductDownloadButtonProps) => (
  <button
    className={`inline-flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-stone-500 transition-colors hover:text-[var(--accent-color)] ${className}`}
