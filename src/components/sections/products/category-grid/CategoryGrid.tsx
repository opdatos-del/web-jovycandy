...
export const CategoryGrid = () => {
  ...
  return (
    <section className="py-24 md:py-32 px-6 md:px-12 lg:px-24 bg-white min-h-screen flex flex-col relative z-10">
      <div className="max-w-[1600px] mx-auto w-full flex-grow flex flex-col">
        <h2 className="text-stone-400 text-xs uppercase tracking-[0.5em] mb-12 font-mono opacity-80 text-center md:text-left">
