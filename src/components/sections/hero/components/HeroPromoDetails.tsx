...
export const HeroPromoDetails = ({ detailRef, promo }: HeroPromoDetailsProps) => (
  <div
    ref={detailRef}
    className="absolute bottom-4 left-1/2 flex w-[min(92vw,34rem)] -translate-x-1/2 flex-col items-center px-3 text-center sm:bottom-8 md:bottom-12 lg:bottom-16"
  >
