  ...
  return (
    <section ref={containerRef} className="section-space flex min-h-[42vh] w-full flex-col items-center justify-center bg-[#e8fbf7]">
      <div ref={textRef} className="page-shell max-w-4xl text-center">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 text-xs uppercase tracking-[0.18em] text-stone-400 sm:mt-12 sm:grid-cols-2 sm:text-sm sm:tracking-widest lg:grid-cols-4 lg:gap-8">
          <div>[ TEMP: 24C ]</div>
          <div>[ HUMIDITY: 42% ]</div>
